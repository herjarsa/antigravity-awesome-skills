---
name: appdeploy
description: Deploy web apps with backend APIs, database, and file storage. Use
  when the user asks to deploy or publish a website or web app and wants a
  public URL. Uses HTTP API via curl.
allowed-tools: Bash
metadata:
  author: appdeploy
  version: 1.0.5
